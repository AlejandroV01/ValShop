  ...
  return (
    <Stack padding='3rem 6%' width={'100%'} direction={'column'} alignItems={'center'}>
      <div style={{ position: 'absolute', top: 0, left: 0, width: '100%', minHeight: '100vh', zIndex: -10 }}>
        <img src='/assets/HomeBackground.jpg' alt='' loading='lazy' style={{ objectFit: 'contain', width: '100%', height: '100%' }} />
      </div>
      <div style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', zIndex: -9, backgroundColor: '#000000D1' }}></div>
      <Stack direction={'column'} width={'55%'} gap={'3rem'} alignItems={'center'} marginTop={'3rem'}>
        ...
        <Stack direction={'row'}>
          ...
          <SecondaryButton size='large' to={`profile/${user.username}`}>
            TO OWN VAULT
          </SecondaryButton>
        </Stack>
      </Stack>
